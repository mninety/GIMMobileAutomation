...
import io.appium.java_client.pagefactory.AppiumFieldDecorator;
	...
	AndroidDriver driver;
		...
		//Page Constants
		@AndroidFindBy(id="com.ejogajog.serviceseeker:id/iv_drawer_profile_image")
		public WebElement ProfilePhoto;
		
		@AndroidFindBy(id="com.ejogajog.serviceseeker:id/tv_drawer_user_name")
		public WebElement ProfileUserName;
		
		@AndroidFindBy(id="com.ejogajog.serviceseeker:id/tv_drawer_user_type")
		public WebElement ProfileType_Status;
		
		@AndroidFindBy(id="com.ejogajog.serviceseeker:id/design_menu_item_text")
		public List<WebElement> ProfileMenu;
		
		@AndroidFindBy(id="com.ejogajog.serviceseeker:id/notification_sound_switch")
		public WebElement ToggleNotificationButton;
		
		@AndroidFindBy(id="com.ejogajog.serviceseeker:id/button_place_bid")
