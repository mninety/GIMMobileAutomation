...
AndroidDriver driver;
	...
	//Page Constants
	@AndroidFindBy(id="com.ejogajog.serviceseeker:id/mobile_number_ET")
	public WebElement MobileNumberField;
	
	@AndroidFindBy(id="com.ejogajog.serviceseeker:id/password_ET")
	public WebElement PasswordField;
	
	@AndroidFindBy(id="com.ejogajog.serviceseeker:id/sign_in_button")
