...
public class MobielVerificationScreen {
	...
	//Page Constants
	@AndroidFindBy(id="com.ejogajog.serviceseeker:id/edit_text_mobile_number")
	public WebElement MobileNumberField;
	
	@AndroidFindBy(id="com.ejogajog.serviceseeker:id/checkbox_termOfUse")
	public WebElement ConditionsCheckBox;
	
	@AndroidFindBy(id="com.ejogajog.serviceseeker:id/button_verification")
	public WebElement SendVerificationSMSButton;
	
	@AndroidFindBy(id="com.ejogajog.serviceseeker:id/edit_text_mobile_number")
	public WebElement PinNumberField;
	
	@AndroidFindBy(id="com.ejogajog.serviceseeker:id/button_next")
