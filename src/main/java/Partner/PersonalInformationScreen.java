...
AndroidDriver driver;
	...
	//Page Constants
	@AndroidFindBy(id="com.ejogajog.fleetowner:id/edit_text_password")
	public WebElement PasswordField;
	
	@AndroidFindBy(id="com.ejogajog.fleetowner:id/edit_text_email")
	public WebElement EmailField;
	
	@AndroidFindBy(id="com.ejogajog.fleetowner:id/edit_text_agent_referral_code")
	public WebElement ReferralCodeField;
	
	@AndroidFindBy(id="com.ejogajog.fleetowner:id/button_personal_info_next")
