...
public class GetBookedTripDetails {
	
	public GetBookedTripDetails(){
	...
	public void GetBookedTripDetailsAPI(String authToken, int tripId) throws IOException {
		testdata = new TestData();
		RestAssured.baseURI = testdata.properties.getProperty("env");
		RestAssured.basePath = "/api/v1/trip/getBookedTripDetails";
	...
	public String getBidId() {
		return jsonresponse.getString("data.bidId").toString();
	}
