...
public class TruckDetailsSave {
	
	public TruckDetailsSave() {
	...
	public void TruckDetailsSaveAPI(String authToken, 
		...
		RestAssured.basePath = "/api/v1/truck/save";
	...
	public void TruckDetailsSaveAPI_ResponseTime(Long Benchmarktime, String authToken, int step, String truckID, 
			String truckFitnessCertificatePhoto, 
			String truckFitnessExpiryDate, 
			String truckInsuranceExpiryDate, 
			String truckInsurancePhoto,
