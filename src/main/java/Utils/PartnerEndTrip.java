...
public class PartnerEndTrip {
	
public PartnerEndTrip() {
...
public void EndTripAPI(String authToken, int TripID) throws IOException {
	
	testdata = new TestData();
	json.addProperty("id", TripID);
	
	RestAssured.baseURI = testdata.properties.getProperty("env");
	RestAssured.basePath = "/api/v1/fleetOwner/endtrip";
