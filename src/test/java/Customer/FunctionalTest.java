...
public class FunctionalTest extends AppiumBase {
	...
	public void setUp() throws IOException {
		...
		capabilities.setCapability("udid", testdata.properties.getProperty("deviceName_vivoY21L"));
		capabilities.setCapability("deviceName", testdata.properties.getProperty("deviceName_vivoY21L"));
	...
	public void CreateTrip_ForApprovedUser() throws IOException, InterruptedException {
		...
		/*
		 * mytripsscreen.clickBurgerMenu(); nidscreen.scrollTo("Logout");
		 * profile.LogoutLink(); profile.clickYesLogoutButton();
		 */
	...
	@Test(priority=14)
	public void CheckBidWithdrawnNotification() {
